...
<html>
    ...
    <body>
        <header>Sistema de Partidas</header>
        ...
        <div id="formulario">
            ...
            <form id="formularioCadastro">
                ...
                <div id="linha">
                    <label for="goleiroCadastro">Goleiro|sim ou não?</label>
                    <input type="text" name="goleiroCadastro" id="goleiroCadastro" />
                </div>
        ...
        <footer>Sistema de Partidas &copy; 2022</footer>
    </body>
</html>