$(function(){
    ...
    $("button#btnCadastrar").on("click", function(e){
        ...
        var campoGoleiro = $("form#formularioCadastro #goleiroCadastro").val();

        if(campoEmail.trim() == "" || campoSenha.trim() == "" || campoNome.trim() == "" || campoGoleiro.trim() == ""){
            $("div#mensagem").show().removeClass("red").html("Preencha todos os campos.");
        }else{
            $.ajax({
                url: "actions/acesso.php",
